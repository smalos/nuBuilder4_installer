...
$arrLang['admin_login_info'] = "Your username must be at least 6 characters long and case-sensitive.";
...
$arrLang['database_name_info'] = "The database used to hold the data. An example of database name is 'nubuilder4'.";
$arrLang['database_username'] = "Database Username";
$arrLang['database_username_info'] = "The username used to connect to the database server. An example of username is 'root'.";
$arrLang['database_password'] = "Database Password";
$arrLang['database_password_info'] = "The password is used together with the username, which forms the database user account.";
...
$arrLang['proceed_to_login_page'] = "Open login page";
$arrLang['ready_to_install'] = "Creating the Configuration File";
...
$arrLang['we_are_ready_to_installation_text'] = "At this step setup wizard will attempt to create the configuration file (nuconfig.php). <br>If something goes wrong, go back to the Database Settings step and make sure every information you've entered is correct.";
