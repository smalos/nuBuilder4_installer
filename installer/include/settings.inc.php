<?php
    ...
    define('EI_PHP_MINIMUM_VERSION', '7.1.0');
    ...
    define('EI_DB_MINIMUM_VERSION', '5.5.0');    
    ...
    define('EI_CONFIG_FILE_NAME', 'nuconfig.php');
    ...
    define('EI_CHECK_ALREADY_INSTALLED', false);      
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'nuBuilder Forte');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v4');
    ...
    define('EI_POST_INSTALLATION_TEXT', 'After logging in, follow the instructions in the <a href="https://wiki.nubuilder.net/nubuilderforte/index.php/Setup#Setup_Inside_nuBuilder" target="_blank">nuBuilder Wiki</a>.');
